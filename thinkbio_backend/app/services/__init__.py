...
from .DB_CLI_services import Transfert_donnes_CLIENT_ISAFACT_CLI, suppression_doublon_by_TEL1, suppression_doublon_by_TEL2, suppression_doublon_by_EMAIL, suppression_doublon_by_TEL1_ET_TEL2, numerotation_client
